...
<div id="redux-header">
    ...
    <?php } ?>
        <h2>
            <a href="https://brandexponents.com/oshine-knowledgebase" target="_blank" style="color: #ffffff; padding-right: 10px; margin-top: 20px; position: relative; top: 47px;" ><?php _e( 'Visit Documentation', 'redux-framework' ); ?></a>
        </h2>
