(function($){
	...
	function be_can_update_plugin(){
        if(typeof be_redirect !=='undefined' && typeof be_redirect.be_is_theme_valid !== 'undefined' && be_redirect.be_is_theme_valid=="0"){
			...
			var check_plugin = ['#be-gdpr-update','#be-grid-update','#tatsu-update','#typehub-update','#colorhub-update','#oshine-core-update','#oshine-modules-update','#be-portfolio-post-update'];
			...
			// if($('#setting-error-tgmpa').length && $('#setting-error-tgmpa p span').length>2){
