...
?>
	<rs-module-wrap id="rev_slider_1028_1_wrapper" data-alias="benefit-addons" data-source="gallery" style="background:transparent;padding:0;margin:0px auto;margin-top:0;margin-bottom:0;">
				<rs-module id="rev_slider_1028_1" class="feature_slider" style="" data-version="6.2.50">
					<rs-slides>
						<rs-slide style="position: absolute;" data-key="rs-2089" data-title="Slide" data-in="o:0;" data-out="a:false;">
...
<!--
							...
							><!--
								...
								>Add Extra Oomph To Your Websites With Creative Addons 
								</rs-layer><!--
								...
								--><rs-layer
									...
									style="z-index:13;"
								><img src="<?php echo RS_PLUGIN_URL;?>admin/views/features/assets/coveraddons.jpg" alt="" class="tp-rs-img" width="760" height="428" data-no-retina> 
								</rs-layer><!--

								--><rs-layer
									id="slider-1028-slide-2089-layer-7" 
									class="rs-noevents"
									data-type="text"
								...
								>Never box in your creativity with our 25+ flawlessly responsive addons 
								</rs-layer><!--
							--></rs-group><!--
-->						</rs-slide>
					</rs-slides>
